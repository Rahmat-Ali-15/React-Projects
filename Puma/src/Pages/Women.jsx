...
export const Women = () => {
  ...
  useEffect(() => {
    const fetchWomenProductData = async () => {
      try {
        const newWomenData = await api.get("/women_product");
        setWomenProducts(newWomenData.data);
      } catch (error) {
        console.log("🚀 ~ error:", error);
      }
    };
    fetchWomenProductData();
  }, []);
